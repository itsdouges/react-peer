...
const App = () => {
  ...
  return (
    <div className="App">
      ...
      <br />
      <strong>useRecievePeerState()</strong> <br />
      connected: {JSON.stringify(isConnected)} <br />
      recieved state: {JSON.stringify(peerState)} <br />
